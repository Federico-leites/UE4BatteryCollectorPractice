...
public:
	...
	/** Accesor function for the initial power */
	UFUNCTION(BlueprintPure, Category = "Power")
	float GetInitialPower();

	/** Accesor function for the current power	*/
	UFUNCTION(BlueprintPure, Category = "Power")
	float GetCurrentPower();

	/** Accesor function to update the character power
	* @param PowerChange Amount to change the power by, it can be positive or negative
	*/
